const ServiceCard = () => {
  return (
    <div className="2xl:pt-16 flex justify-center gap-5 text-[#171717]">
      {/* Card One */}
      <div className="bg-neutral-200/60 border-3 border-dashed border-neutral-300/60 backdrop-blur-2xl max-w-[600px] px-[40px] py-[60px] text-center rounded-2xl flex flex-col items-center w-full group hover:bg-[#171717] hover:border-neutral-300 cursor-pointer">
